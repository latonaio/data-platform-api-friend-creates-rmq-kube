...
import (
	...
	dpfm_api_output_formatter "data-platform-api-friend-creates-rmq-kube/DPFM_API_Output_Formatter"
...
func (c *DPFMAPICaller) generalCreateSql(
	...
	res, err := c.rmq.SessionKeepRequest(nil, c.conf.RMQ.QueueToSQL()[0], map[string]interface{}{"message": generalData, "function": "FriendGeneral", "runtime_session_id": sessionID})
	if err != nil {
...
func generalIsUpdate(general *dpfm_api_processing_formatter.GeneralUpdates) bool {
	...
	friend			:= general.Friend

	return !(businessPartner == 0 || friend == 0)
}
